...
func Decode(data []byte) (gslang.Object, error) {
	var d decodeState
...
func (d *decodeState) value() (gslang.Object, error) {
	switch d.opcode {
	default:
		panic(phasePanicMsg)
	case scanBeginArray:
...
func (d *decodeState) array() (gslang.Object, error) {
	var arr []gslang.Object
	for {
	...
	return &gslang.Array{Value: arr}, nil
}

func (d *decodeState) object() (gslang.Object, error) {
	m := make(map[string]gslang.Object)
	for {
	...
	return &gslang.Map{Value: m}, nil
}

func (d *decodeState) literal() (gslang.Object, error) {
	...
	default: // number
		...
		return &gslang.Float{Value: n}, nil
	}
}
